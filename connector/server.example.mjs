...
const leads = [
    { lead_id: 'L-1001', lead_name: 'Sample Lead 1', email: 'lead1@example.test', source: 'Referral' },
    { lead_id: 'L-1002', lead_name: 'Sample Lead 2', email: 'lead2@example.test', source: 'Inbound' }
];
